...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('1000000000000'); // Your max supply. (Here, 1 billion tokens)
        const decimals: u8 = 18; // 16
        const name: string = 'Test'; // GRIFFIN
        const symbol: string = 'TEST'; // GRIF 
